...
public:
    ...
    void Render(CCamera* pCamera, CMaterial* pOverride = nullptr, CLight* pDirectionalLight = nullptr, int colormapMode = 0, float scalarMin = 0.0f, float scalarMax = 1.0f, bool showWireframe = false, float wireframeThickness = 1.0f, float displacementScale = 0.0f);
